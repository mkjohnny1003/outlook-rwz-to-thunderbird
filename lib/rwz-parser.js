...
class RwzParser {
  ...
  static parse(buffer) {
    ...
    if (sig === 1310720) {
      result.version = 'outlook2019';
      result.versionLabel = 'Outlook 2016/2019/365';
    } else if (sig === 1500000) {
      result.version = 'outlook2013';
      result.versionLabel = 'Outlook 2013';
    } else if (sig === 1400000) {
      result.version = 'outlook2010';
      result.versionLabel = 'Outlook 2010';
    } else if (sig === 1200000) {
      result.version = 'outlook2007';
      result.versionLabel = 'Outlook 2007';
    } else if (sig === 1100000) {
      result.version = 'outlook2003';
      result.versionLabel = 'Outlook 2003';
    } else if (sig === 1000000) {
      result.version = 'outlook2002';
      result.versionLabel = 'Outlook 2002';
    } else if (sig === 980413) {
      result.version = 'outlook2000';
      result.versionLabel = 'Outlook 2000';
    } else if (sig === 970812) {
      result.version = 'outlook98';
      result.versionLabel = 'Outlook 98';
    } else {
      result.version = 'outlook-generic';
      result.versionLabel = `Outlook (Sig: ${sig})`;
    }
